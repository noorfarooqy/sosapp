            ...
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="border-left-info ">
                                    ...
                                    <span style="color:black"
                                        v-if="user_title_text !== null">@{{user_title_text}}</span>
                                ...
                                <div class="border-left-info mt-4">
                                    ...
                                    <span style="color:black"
                                        v-if="living_country_text !== null">@{{living_country_text}}</span>
                    ...
                    <div class="col-lg-6 card">
                            <div class="card-header">
                                <h4 class="h4 text-gray-900 mb-2">Update account information </h4>
                                <div class="mb-4" style="font-size: 12px">
                                    You will be able to submit papers and get access to other functions in completing
                                    the setup.
                                </div>
                            </div>
                            <form class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_title" id="user_title" v-model="user_title"
                                        class="select form-control form-control-user" style="height:auto"
                                        @change.prevent="updateTitleText($event)" :class="getErrorDetails(0)">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="profession"
                                        v-model="profession" aria-describedby="emailHelp"
                                        placeholder="Enter city name..." :class="getErrorDetails(1)"
                                        @change.prevent="resetError(1)">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="title" class="label">Which city do you live in
                                        @{{living_country_text}}?</label>
                                    <input type="text" class="form-control form-control-user" name="living_city"
                                        v-model="living_city" aria-describedby="emailHelp"
                                        placeholder="Enter city name..." :class="getErrorDetails(3)"
                                        @change.prevent="resetError(3)">
                                </div>
                                <div class="form-group">
                                    <label for="title" class="label">Which institute do you attend?</label>
                                    <input type="text" class="form-control form-control-user" name="inst_name"
                                        v-model="inst_name" aria-describedby="emailHelp"
                                        placeholder="Enter Institute name..." :class="getErrorDetails(4)"
                                        @change.prevent="resetError(4)">
                                </div>
                                <div class="form-group">
                                    <label for="title" class="label">where is
                                        ...
                                        ?</label>
                                    <input type="text" class="form-control form-control-user " name="inst_name"
                                        v-model="inst_location" aria-describedby="emailHelp"
                                        placeholder="Enter Institute location..." :class="getErrorDetails(5)"
                                        @change.prevent="resetError(5)">
                                </div>
                                <div class="form-group">
