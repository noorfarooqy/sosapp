        ...
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div>
                        <p class="mb-0 font-weight-bold">Authors</p>
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div>
                        <p class="mb-0 font-weight-bold">Publications</p>
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-15">
            <div class="card-body">
                <div class="d-flex mb-2">
                    <div>
                        <p class="mb-0 font-weight-bold">Downloads</p>
        ...
        <div class="card radius-15">
            <div class="card-header border-bottom-0">
                <div class="d-lg-flex align-items-center">
                    <div>
                        <h5 class="mb-lg-0">New VS Returning authors</h5>
                    </div>
    ...
    <div class="col-12 col-lg-4">
        <div class="card radius-15">
            ...
            <ul class="list-group list-group-flush mb-0">
                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Mobile<span
                        class="badge badge-danger badge-pill">25%</span>
                </li>
                ...
                <li class="list-group-item d-flex justify-content-between align-items-center bg-transparent">Tablet<span
                        class="badge badge-warning badge-pill">10%</span>
                </li>
            </ul>
        </div>
    </div>
...
<div class="card-deck flex-column flex-lg-row">
    <div class="card radius-15">
        <div class="card-body">
            ...
            <div class="media align-items-center">
                <div>
                    <img src="/admin/assets//images/icons/chrome.png" width="35" height="35" alt="" />
                </div>
            ...
            <div class="media align-items-center">
                <div>
                    <img src="/admin/assets//images/icons/firefox.png" width="35" height="35" alt="" />
                </div>
                <div class="media-body ml-3">
            ...
            <div class="media align-items-center">
                <div>
                    <img src="/admin/assets//images/icons/edge.png" width="35" height="35" alt="" />
                </div>
                <div class="media-body ml-3">
            ...
            <div class="media align-items-center">
                <div>
                    <img src="/admin/assets//images/icons/opera.png" width="35" height="35" alt="" />
                </div>
                <div class="media-body ml-3">
            ...
            <div class="media align-items-center">
                <div>
                    <img src="/admin/assets//images/icons/safari.png" width="35" height="35" alt="" />
                </div>
                <div class="media-body ml-3">
...
<div class="card radius-15">
    <div class="card-body">
        <div class="card-title">
            <h5 class="mb-0">Top publications by views </h5>
        </div>
        <hr />
        <div class="table-responsive">
